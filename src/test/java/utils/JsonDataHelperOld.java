...
//
//
//    private static JsonDataHelper jsonDataHelper;
//
//    private JsonDataHelper() {
//    }
//
//    public static JsonDataHelper getInstance() {
//        if (jsonDataHelper != null) {
//        }
//        synchronized (JsonDataHelper.class) {
//            if (jsonDataHelper == null) {
...
public enum JsonDataHelperOld {
    INSTANCE;

    private static final Logger logger = LogManager.getLogger(JsonDataHelperOld.class);
    private List<Map<String, String>> tcDataList = null;
    private Map<String, String> tcData = null;
